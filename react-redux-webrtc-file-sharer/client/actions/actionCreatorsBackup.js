...
export function onFileData(files, data, isOwnFile, fileProgressValue, chunkFileSize, fileBuffer, fileLeecher) {
	return {
		type: ON_FILE_DATA,
		files,
		data,
...
export function onPeerFile(fileObject, argFile, argChunkFileSize, argFileProgressValue, filteredFiles) {
	return {
		type: ON_PEER_FILE,
		fileObject,
		argFile,
		argChunkFileSize,
		argFileProgressValue,
		filteredFiles
	}
}
